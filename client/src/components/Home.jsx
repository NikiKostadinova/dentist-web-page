...
export default function Home() {
    return (
        <div className='bg-black h-screen  text-white justify-center md:items-center content-center text-center py-16'>
            ...
            <h1 className='text-4xl font-bold'>Healthy Smiles for the Whole Family</h1>
